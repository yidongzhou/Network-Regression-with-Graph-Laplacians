...
- `data/`: This folder contains part of the data used in the first data application of the paper : New York Yellow Taxi System After COVID-19 Outbreak.
  ...
  - `yellowTripdata2020`: A subset of the yellow taxi trip records used for demonstration purposes. Due to the large size of the complete dataset, only a portion of the data is included in this repository. The yellow taxi trip records contain information on pick-up and drop-oﬀ dates/times, pick-up and drop-oﬀ locations, trip distances, itemized fares, rate types, payment types and driver-reported passenger counts, collected by New York City Taxi and Limousine Commission (NYC TLC). For the complete and most up-to-date data, please download directly from the [NYC TLC Trip Record Data page](https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.page).
